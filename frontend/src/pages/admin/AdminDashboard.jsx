          ...
          {selected ? (
            <div className="card details">
              ...
              <div className="grid-2">
                ...
                <Detail label="Coordinates" value={`${selected.latitude || "—"}, ${selected.longitude || "—"}`} />
    ...
    <ul className="photo-list">
      {selected.photos.map((p, i) => (
        <li key={i} className="photo-item">
          <a href={`http://localhost:5000${p}`} target="_blank" rel="noreferrer" className="photo-link"> 📷 photo-{i + 1}</a>
        </li>
      ))}
    </ul>
  </div>
